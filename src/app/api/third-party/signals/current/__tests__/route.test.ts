...
describe('GET /api/third-party/signals/current', () => {
  const mockRequest = (queryParams: Record<string, string> = {}, headers: Record<string, string> = {}) => {
    const url = new URL('http://localhost/api/third-party/signals/current');
  ...
  it('should successfully return current signals', async () => {
